...
```
criminalsquad sync            # sincroniza pacotes com direito (skills + acervo)
criminalsquad sync --check    # o que está desatualizado
criminalsquad areas           # áreas instaladas vs disponíveis
criminalsquad areas add <id>  # instala uma área que a licença libera
```
