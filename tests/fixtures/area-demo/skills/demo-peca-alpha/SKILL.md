---
name: demo-peca-alpha
description: >-
  Use ao lidar com demo-peca-alpha na área fictícia demo — cenário sintético que exercita o motor
  sem depender de matéria jurídica real. Gatilhos: demo-peca-alpha, demo alpha.
...
metadata:
  ...
  eval_case_ids: ["demo-v5-demo-peca-alpha"]
  risk_level: "r4"
  delivery_type: "legal-draft"
  freshness_policy: "official-current-source-required"
  positive_triggers: ["demo-peca-alpha", "demo alpha"]
...
# demo-peca-alpha (fixture sintética)
