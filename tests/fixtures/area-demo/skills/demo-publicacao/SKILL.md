---
name: demo-publicacao
description: >-
  Use ao lidar com demo-publicacao na área fictícia demo — cenário sintético que exercita o motor
  sem depender de matéria jurídica real. Gatilhos: demo-publicacao, demo publicacao.
...
metadata:
  ...
  eval_case_ids: ["demo-v5-demo-publicacao"]
  risk_level: "r2"
  delivery_type: "external-mutation"
  freshness_policy: "official-current-source-required"
  positive_triggers: ["demo-publicacao", "demo publicacao"]
...
# demo-publicacao (fixture sintética)
