...
name: demo-deprecada
description: >-
  Use ao lidar com demo-deprecada na área fictícia demo — cenário sintético que exercita o motor
  sem depender de matéria jurídica real. Gatilhos: demo-deprecada, demo deprecada.
...
metadata:
  ...
  eval_case_ids: ["demo-v5-demo-deprecada"]
  risk_level: "r2"
  delivery_type: "legal-draft"
  freshness_policy: "official-current-source-required"
  positive_triggers: ["demo-deprecada", "demo deprecada"]
