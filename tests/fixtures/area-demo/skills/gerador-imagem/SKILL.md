...
name: gerador-imagem
description: >-
  Use ao lidar com gerador-imagem na área fictícia demo — cenário sintético que exercita o motor
  sem depender de matéria jurídica real. Gatilhos: gerador-imagem, demo imagem.
...
metadata:
  ...
  eval_case_ids: ["demo-v5-gerador-imagem"]
  risk_level: "r1"
  delivery_type: "external-mutation"
  freshness_policy: "official-current-source-required"
  positive_triggers: ["gerador-imagem", "demo imagem"]
...
# gerador-imagem (fixture sintética)
