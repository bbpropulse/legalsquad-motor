---
name: demo-quarentena
description: >-
  Use ao lidar com demo-quarentena na área fictícia demo — cenário sintético que exercita o motor
  sem depender de matéria jurídica real. Gatilhos: demo-quarentena, demo quarentena.
...
metadata:
  ...
  eval_case_ids: ["demo-v5-demo-quarentena"]
  risk_level: "r4"
  delivery_type: "legal-draft"
  freshness_policy: "official-current-source-required"
  positive_triggers: ["demo-quarentena", "demo quarentena"]
...
# demo-quarentena (fixture sintética)
