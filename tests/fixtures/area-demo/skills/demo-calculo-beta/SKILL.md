---
name: demo-calculo-beta
description: >-
  Use ao lidar com demo-calculo-beta na área fictícia demo — cenário sintético que exercita o motor
  sem depender de matéria jurídica real. Gatilhos: demo-calculo-beta, demo beta.
...
metadata:
  ...
  eval_case_ids: ["demo-v5-demo-calculo-beta"]
  risk_level: "r3"
  delivery_type: "audit-calculation"
  freshness_policy: "official-current-source-required"
  positive_triggers: ["demo-calculo-beta", "demo beta"]
...
# demo-calculo-beta (fixture sintética)
