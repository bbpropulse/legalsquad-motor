...
name: "Revisão B"
type: agent
description: Vera Revisão B confere o checklist de consistência, em paralelo com a Revisão A.
---
...
Vera Revisão B confere o checklist de consistência, em paralelo com a Revisão A.
